document.addEventListener('DOMContentLoaded', () => {
    ...
    const applicationServerKey =
        'BJkBiAd8Hj-2sJzx0ZdmM8-vX7Y5dtd2JhD-HPAqWH1Ee8U1WBZ7X_NFhux7WxBFKBvNBfNYolaG261Qj64iskI';
    ...
    function changePushButtonState(state) {
        switch (state) {
            ...
            case 'incompatible':
                pushButton.disabled = true;
                pushButton.textContent = 'Push Notification Not Compatible';
                break;
            default:
    ...
    function push_sendSubscriptionToServer(subscription, method) {
        ...
        return fetch((method == 'subscribe') ? 'push_subscription.php' : 'push_unsubscription.php', {
            method: 'POST',
            body: JSON.stringify({
